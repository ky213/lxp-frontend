...
const EditProgram = (props) => {
  ...
  const [remainder, setRemainder] = React.useState(
    (program &&
      program.dutyTimeFrom &&
      30 - (moment(`${today}T${program.dutyTimeFrom}`).minute() % 30)) ||
      0
  );
      ...
      programService
        ...
        .then((data) => {
          ...
          if (data) {
            ...
            const to =
              (data.dutyTimeTo && moment(`${today}T${data.dutyTimeTo}`)) ||
              null;
            const from =
              (data.dutyTimeFrom && moment(`${today}T${data.dutyTimeFrom}`)) ||
              null;

            const calculatedTimeDifference =
              (to &&
                from &&
                Math.round(
                  moment
        ...
        <Formik
          ...
          initialValues={{
            ...
            timeFrom:
              (program &&
                program.dutyTimeFrom &&
                moment(`${today}T${program.dutyTimeFrom}`).toDate()) ||
              '',
            timeTo:
              (program &&
                program.dutyTimeTo &&
                moment(`${today}T${program.dutyTimeTo}`).toDate()) ||
              '',
            allowedAnnualVacationWeeks:
              (program && program.allowedAnnualVacationWeeks) || '',
            allowedEducationalLeaveDays:
              (program && program.allowedEducationalLeaveDays) || '',
            allowedEmergencyLeaveDays:
              (program && program.allowedEmergencyLeaveDays) || '',
            totalBlock:
              (program &&
                program.totalBlockJunior + program.totalBlockJunior) ||
              '',
            ...
            seniorLearnersStartLevel:
              (program && program.seniorLearnersStartLevel) || '',
          }}
          validationSchema={Yup.object().shape({
            name: Yup.string().required('Name of a program is required'),
            description: Yup.string().max(
              300,
              'Description cant be more than 300 characters long'
            ),
            timeFrom: Yup.date().required(
              'You need to enter the start of duty hours'
            ),
            timeTo: Yup.date().required(
              'You need to enter the end of duty hours'
            ),
            allowedAnnualVacationWeeks: Yup.string().required(
              'Allowed Annual Vacation is required'
            ),
            allowedEducationalLeaveDays: Yup.string().required(
              'Allowed Educational Vacation is required'
            ),
            allowedEmergencyLeaveDays: Yup.string().required(
              'Allowed Emergency Vacation is required'
            ),
            ...
            blockType: Yup.string().required(
              'You need to select the block type'
            ),
            ...
            if (program) {
              programService
                .update({
                  ...
                  description,
                  timeFrom:
                    (timeFrom && moment(timeFrom).format('HH:mm:ss')) || null,
                ...
                .then(
                  ...
                  (error) => {
                    let alertMessage = {
                      title: 'Error',
                      message: `Error while changing program: ${error}`,
                      type: 'danger',
                    };
                    props.onEdited(alertMessage);
                    setSubmitting(false);
                    ...
                    <CardBody>
                      ...
                      <Form>
                                ...
                                return (
                                  <InputGroup>
                                    ...
                                    <DatePicker
                                      ...
                                      className={
                                        'bg-white form-control' +
                                        (formikProps.errors.timeFrom &&
                                        formikProps.touched.timeFrom
                                          ? ' is-invalid'
                                          : '')
                                      }
                                      showTimeSelectOnly
                                ...
                                return (
                                  <InputGroup>
                                    ...
                                    <DatePicker
                                      ...
                                      className={
                                        'bg-white form-control' +
                                        (formikProps.errors.timeTo &&
                                        formikProps.touched.timeTo
                                          ? ' is-invalid'
                                          : '')
                                      }
                                      showTimeSelectOnly
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                ...
                                (formikProps.errors
                                  .allowedAnnualVacationWeeks &&
                                formikProps.touched.allowedAnnualVacationWeeks
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Weeks..."
                          ...
                          <Label className="col-form-label">Weeks</Label>
                        </FormGroup>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                ...
                                (formikProps.errors
                                  .allowedEducationalLeaveDays &&
                                formikProps.touched.allowedEducationalLeaveDays
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Days..."
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.allowedEmergencyLeaveDays &&
                                formikProps.touched.allowedEmergencyLeaveDays
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Days..."
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.totalBlock &&
                                formikProps.touched.totalBlock
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Block..."
                          ...
                          <Label className="col-form-label">Block(s)</Label>
                        </FormGroup>
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.totalBlockSenior &&
                                formikProps.touched.totalBlockSenior
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Block..."
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.totalBlockJunior &&
                                formikProps.touched.totalBlockJunior
                                  ? ' is-invalid'
                                  : '')
                              }
                              placeholder="Block..."
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={3}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.blockType &&
                                formikProps.touched.blockType
                                  ? ' is-invalid'
                                  : '')
                              }
                            >
                              ...
                              {blockTypes.map((blockType) => {
                                ...
                                return (
                                  <option value={blockType.blockTypeId}>
                                    {blockType.blockTypeDescription}
                                  </option>
                                );
                              })}
                            </Field>
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={1}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.minExperienceLevel &&
                                formikProps.touched.minExperienceLevel
                                  ? ' is-invalid'
                                  : '')
                              }
                          ...
                          <Col sm={1}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.maxExperienceLevel &&
                                formikProps.touched.maxExperienceLevel
                                  ? ' is-invalid'
                                  : '')
                              }
                        ...
                        <FormGroup row>
                          ...
                          <Col sm={2}>
                            <Field
                              ...
                              className={
                                'bg-white form-control' +
                                (formikProps.errors.seniorLearnersStartLevel &&
                                formikProps.touched.seniorLearnersStartLevel
                                  ? ' is-invalid'
                                  : '')
                              }
                          ...
                          <Label className="col-form-label"> (onwards)</Label>
                        </FormGroup>

                        <FormGroup row>
                          <Col sm={3} />
                          <Col sm={9}>
                            <ThemedButton type="submit" disabled={!program}>
                              {'Update'}
                            </ThemedButton>{' '}
                            {props.programs && props.programs.length > 1 && (
                              <Button
                                type="button"
