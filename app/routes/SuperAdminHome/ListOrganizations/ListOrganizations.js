        ...
        <Col lg={12}>
          <HeaderDemo
            ...
            subTitle={intl.formatMessage({
              id: 'SuperAdminHome.ListOrganizations.Subtitle',
            })}
          />
        </Col>
      </Row>
                ...
                <ButtonToolbar>
                  ...
                  <ButtonGroup className="ml-auto ml-lg-0">
                    ...
                    >
                      {intl.formatMessage({
                        id:
                          'SuperAdminHome.ListOrganizations.AddNewOrganization',
                      })}
                    </UncontrolledTooltip>
                  </ButtonGroup>
                </ButtonToolbar>
              ...
              <tbody>
                {(organizations &&
                  ...
                  <tr>
                    <td colSpan={5}>
                      {intl.formatMessage({
                        id: 'SuperAdminHome.ListOrganizations.NoOrganizations',
                      })}
                    </td>
                  </tr>
                )}
