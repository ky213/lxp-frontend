...
const DlRowContacts = (props) => {
    console.log("Contacts:", props, props.selectedUser && props.selectedUser.email)
    return (
        <React.Fragment>
            <dl className="row">
                <dt className={ `col-sm-3 ${ props.leftSideClassName }` }>Phone</dt>
                <dd className={ `col-sm-9 ${ props.rightSideClassName }` }>{props.selectedUser && props.selectedUser.phone}</dd>
                <dt className={ `col-sm-3 ${ props.leftSideClassName }` }>Mobile</dt>
                <dd className={ `col-sm-9 ${ props.rightSideClassName }` }>{props.selectedUser && props.selectedUser.mobile}</dd>
                <dt className={ `col-sm-3 ${ props.leftSideClassName }` }>Fax</dt>
                <dd className={ `col-sm-9 ${ props.rightSideClassName }` }>{props.selectedUser && props.selectedUser.fax}</dd>
