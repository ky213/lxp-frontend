...
function deleteFile(announcementFileId) {
  ...
  return fetch(`${routePrefix}/deleteFile/${announcementFileId}`, requestOptions)
      .then(handleResponse)
      .then((data) => {
          return data;
      });
...
function downloadFile(announcementFileId) {
  ...
  return fetch(`${routePrefix}/downloadFile/${announcementFileId}`, requestOptions)
      .then(handleResponse)
      .then((data) => {
          return data;
      });
...
function markAnnouncementAsRead(announcementId) {
  ...
  return fetch(`${routePrefix}/markAnnouncementAsRead/${announcementId}`, requestOptions).then(handleResponse);
}
...
function deleteAnnouncements(announcements) {
   ...
   return fetch(`${routePrefix}/deleteAnnouncements`, requestOptions)
       .then(handleResponse);
}