...
const GroupTypes = () => {
    ...
    const [selectedGroupTypeId, setSelectedGroupTypeId] = React.useState(null);
    ...
    const getGroupTypes = () => {        
        groupTypesService.getAll(selectedOrganization && selectedOrganization.organizationId, pageId, recordsPerPage, searchText).then((data) => {
    ...
    const handleGroupTypeEdit = (groupTypeId) => {
            ...
            <Container>
                ...
                {showGroupTypeForm && (
                    <>
                        ...
                        <Row>
                            <AddEditGroupType groupTypeId={selectedGroupTypeId}
                ...
                {!showGroupTypeForm && (<>
                    ...
                    <Row>
                        ...
                        <ListGroupTypes groupTypes={groupTypes}
