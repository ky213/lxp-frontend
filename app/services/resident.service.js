...
function getAll(pageId, recordsPerPage, filterName, filterInstituteId, filterProgramId) {    
  const requestOptions = { method: 'GET', headers: authHeader() };
  let query = buildQuery({pageId, recordsPerPage, filterName, filterInstituteId, filterProgramId});
...
function getAllActive(pageId, recordsPerPage, filterName, filterInstituteId) {    
  const requestOptions = { method: 'GET', headers: authHeader() };
  let query = buildQuery({pageId, recordsPerPage, filterName, filterInstituteId});
