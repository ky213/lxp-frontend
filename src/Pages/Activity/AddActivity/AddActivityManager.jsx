...
import SearchInput from '../../Common/FormControlls/SearchInput/SearchInput';
            ...
            <div className={classes.fieldRadio}>
                ...
                <div className={classes.radios}>
                    <div className={classes.visibilityBlock}>
                        <input type="radio" name="isRepeat" id="yes" onChange={e=>{props.setIsRepeat(e.target.value)}} value={true}/>
                        <label htmlFor={"yes"}>{t("addActivity.yes")}</label>
                        <div className={classes.check}></div>
                    </div>
                    <div className={classes.visibilityBlock}>
                        <input type="radio" name="isRepeat" id="no" defaultChecked={true} onChange={e=>{props.setIsRepeat(e.target.value)}} value={false}/>
